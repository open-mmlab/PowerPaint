...
class StableDiffusionBrushNetPowerPaintPipeline(
    DiffusionPipeline,
    ...
    def __call__(
        ...
        **kwargs,
        ...
        print(con_prompt, con_negprompt)
        con_negative_prompt_embeds = None
        con_prompt_embeds = None
        con_prompt_embeds, con_negative_prompt_embeds = self.encode_prompt(
            con_prompt,
            device,
            num_images_per_prompt,
            self.do_classifier_free_guidance,
            con_negprompt,
            prompt_embeds=con_prompt_embeds,
            negative_prompt_embeds=con_negative_prompt_embeds,
            lora_scale=text_encoder_lora_scale,
            clip_skip=self.clip_skip,
        )
        ...
        if self.do_classifier_free_guidance:
            ...
            con_prompt_embeds = torch.cat([con_negative_prompt_embeds, con_prompt_embeds])
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if guess_mode and self.do_classifier_free_guidance:
                    ...
                    brushnet_prompt_embeds = con_prompt_embeds.chunk(2)[1]
                else:
                    control_model_input = latent_model_input
                    brushnet_prompt_embeds = con_prompt_embeds
